...
<li>
    <a href="{{ route('admin.stats.index') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 transition {{ request()->routeIs('admin.stats.*') ? 'bg-slate-50 text-indigo-600' : 'text-slate-700 hover:bg-slate-50 hover:text-indigo-600' }}">
        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.stats.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
...
<li>
    <a href="{{ route('admin.smart-home.index') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 transition {{ request()->routeIs('admin.smart-home.*') ? 'bg-slate-50 text-indigo-600' : 'text-slate-700 hover:bg-slate-50 hover:text-indigo-600' }}">
        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.smart-home.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        </svg>
        Smart Home
    </a>
...
<li>
    <a href="{{ route('admin.profile') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 transition {{ request()->routeIs('admin.profile') ? 'bg-slate-50 text-indigo-600' : 'text-slate-700 hover:bg-slate-50 hover:text-indigo-600' }}">
        <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.profile') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-indigo-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
