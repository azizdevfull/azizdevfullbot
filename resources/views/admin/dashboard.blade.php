...
<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-8">
    ...
    <div class="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm card-hover">
        <div class="w-9 h-9 rounded-xl bg-sky-50 flex items-center justify-center mb-3">
            <svg class="w-5 h-5 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
        </div>
        <p class="text-2xl font-bold text-slate-800">{{ $chatLanguages->count() }}</p>
        <p class="text-xs text-slate-400 mt-0.5">Chatlar</p>
    </div>
    <div class="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm card-hover">
